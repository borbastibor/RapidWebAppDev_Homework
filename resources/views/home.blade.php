  ...
  <div class="row justify-content-center">
    <div class="col-md-11">
        <div class="card shadow mt-2">
          <div class="card-header bg-secondary shadow-sm text-white font-weight-bold">{{ __('Kezdőlap') }}</div>
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="text-center"><img src="{{ asset('images/1ado.png') }}" alt="adó"></div>
                <h2 class="mb-2">Tisztelt Látogató!</h2>
                ...
                <div class="text-center">
                  ...
                  <p>
                    Az alapítványt támogathatja ha Támogatói matricát vásárol, amelynek az értéke 500,-Ft<br>
