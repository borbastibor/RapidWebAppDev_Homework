        ...
        $.post({
            ...
            response.forEach(function (item, index) {
                $('#data_table > tbody').append(
                    '<tr><td class="align-middle">' + item.orig_name +
                    '</td><td class="align-middle">' + item.description +
                    '</td><td class="align-middle">' + item.type +
                    '</td><td class="align-middle">' + item.created_at +
                    '</td><td class="align-middle">' + item.user_name +
